    ...
    <form>
      ...
      <div class="flex items-center gap-4 mb-4">
        ...
        <select name="documentId" id="documentId" v-model="documentId" required>
          <option value="314bc909-4e7d-423c-8c61-6fb712ab48f4">Compra</option>
        </select>
      </div>
      <div class="flex items-center gap-4 mb-4">
      ...
      <button @click.prevent="addNewRecord" class="mb-4 p-2 bg-blue-500 text-white rounded">
            ...
            <tr v-for="(item, index) in movementDetail" :key="index" class="hover:bg-gray-50">
              <td class="border border-gray-200 px-4 py-2">
                <select
                  name="productId"
                  id="productId"
                  v-model="productId[index].product.id"
                  required
                >
                  <option
