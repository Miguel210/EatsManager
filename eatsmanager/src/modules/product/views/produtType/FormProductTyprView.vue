    ...
    <div>
        <form @submit="onSubmit">
            ...
            <div class="flex items-center gap-4 mb-4">
                <label for="description" class="font-semibold w-24">Nombre del tipo de producto</label>
                <!-- <input type="text" name="fullname" id="fullname" v-model="fullname" v-bind="fullnameAttrs"> -->
                <input v-model="description" v-bind="descriptionAttrs" required />
            </div>
            <div class="flex items-center gap-4 mb-4">
                <label for="useStock" class="font-semibold w-24">Usa stock?</label>
                <select name="useStock" id="useStock" v-model="useStock" :model="useStock" required>
...
<script src="./FormProductTypeView.ts" lang="ts">
