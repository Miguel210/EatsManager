...
exports.DevolutionSupplierEntity = void 0;
const custom_error_1 = require("../errors/custom.error");
class DevolutionSupplierEntity {
    ...
    static fromObject(object) {
        ...
        return new DevolutionSupplierEntity(id, movementId || movement, invoiceFolio, paymentDate, status, isActive);
    }
}
exports.DevolutionSupplierEntity = DevolutionSupplierEntity;
