...
export const seedData = {
    ...
    metric: [
        ...
        {id: '8c4dda96-be9c-4699-9cd9-1e2ba13499e0', operationId: 'b4868909-5189-4711-b6cc-6b373e28a269', name: 'Ordenes_del Dia',      sentence: `select cast(count(m.id) as numeric) from movement m where m."documentId" = '4a00ff37-2f05-4042-abcd-62270aaa31bb'`, isActive: true},
