...
export const seedData = {
    ...
    metric: [
        {id: 'fd4a8819-ce66-4e3c-8926-62aed1ddb3ae', operationId: '74b60331-4ade-4177-96a0-6f536c6fb5b1', name: 'Venta Total',          sentence: `select cast(sum(m."amount") as numeric) from movement m where date_trunc('day', m."date") = date_trunc('day', current_date) and m."documentId" ='4a00ff37-2f05-4042-abcd-62270aaa31bb'`, isActive: true},
        ...
        {id: '46224c20-2a8b-46e8-93b1-5d5459f008b3', operationId: 'b71aade3-6038-413d-b3dd-5bd845febba5', name: 'Ordenes del Dia',      sentence: `select cast(count(m.id)as numeric) from movement m where m."documentId" = '4a00ff37-2f05-4042-abcd-62270aaa31bb'`, isActive: true},
        {id: 'a4aa6a50-f26d-462b-8ead-b9a3ce25af48', operationId: '87fea175-12c4-47ce-aa88-545aac981f6b', name: 'Mas Vendido',          sentence: `select p.description, cast(sum(md."quantity") as numeric) as total from movement m join "movementDetail"  md on m.id=md."movementId" join product p on md."productId"=p.id where p.code like 'PLT%' and m."documentId"='4a00ff37-2f05-4042-abcd-62270aaa31bb' and  date_trunc('day', m."date") = date_trunc('day', current_date) group by p.description order by total desc limit 1;`, isActive: true},
        ...
        {id: '8c4dda96-be9c-4699-9cd9-1e2ba13499e0', operationId: 'b4868909-5189-4711-b6cc-6b373e28a269', name: 'Ordenes del Dia',      sentence: `select cast(count(m.id) as numeric) from movement m where m."documentId" = '4a00ff37-2f05-4042-abcd-62270aaa31bb'`, isActive: true},
        {id: 'bf2445d3-3fe0-4356-a31b-5818823217d2', operationId: '2c6692b3-55a6-4c89-b001-f1760249ad4d', name: 'Ordenes Pendientes',   sentence: `select cast(count(*) as numeric)  from movement m where date_trunc('day', m."date") = date_trunc('day', current_date) and m."documentId" = '4a00ff37-2f05-4042-abcd-62270aaa31bb' and m.status = 'Pendiente'`, isActive: true},
        {id: 'c40745c2-6ecb-4d8b-903f-98a9c2008bce', operationId: '55440f27-9dd3-4c80-8825-96e4c921312b', name: 'Empleados Asistidos',  sentence: `select m."date", cast(count(*) as numeric)  from movement m where date_trunc('day', m."date") = date_trunc('day', current_date) and m."documentId" = '4a00ff37-2f05-4042-abcd-62270aaa31bb' and m."elaborateId" = 'b805d571-14ed-4c3e-a92b-b896ca35daeb' group by m."date" order by m."date"`, isActive: true},
        ...
        {id: '24c781af-fe27-4f31-8dc1-1ea326512ede', operationId: '4a222609-b953-4dab-b8a4-2e22b082a131', name: 'Ordenes Pendientes',   sentence: `select cast(count(*) as numeric)  from movement m where date_trunc('day', m."date") = date_trunc('day', current_date) and m."documentId" = '4a00ff37-2f05-4042-abcd-62270aaa31bb' and m.status = 'Pendiente'`, isActive: true},
        {id: 'ad0f8f23-3735-41a7-905b-7d5e95dba8ce', operationId: '8b54718e-b270-419c-a248-d2986e35c64c', name: 'Ventas Empleados',     sentence: `select cast(count(*) as numeric)  from movement m where date_trunc('day', m."date") = date_trunc('day', current_date) and m."documentId" = '4a00ff37-2f05-4042-abcd-62270aaa31bb' and m.status = 'Pendiente'`, isActive: true},
...
//        { id: '', profileId: '', operationId: '', createAt: new Date(), isActive: true },
    ...
    product: [
        { id: 'dbc7ba01-bb96-4e8b-8436-b0c1d2723236', code: 'DC',       description: 'Devolucion de compra',        isActive: true, productTypeId: 'e282b267-07b7-458c-b828-c4faf1b71159', categoryId: '71de1875-8ba0-4e1a-b17f-531de9df1114',    price: 0.00, existence: 0, image: '', viewMenu: false},
        { id: '1a3f49bd-3c1e-4fcf-b636-9c1df7d8aaae', code: 'INS-0001', description: 'Salsa de Tomate',             isActive: true, productTypeId: '2aaec104-dc80-4a92-b748-a40a052e9ce6', categoryId: 'cb6e94d8-ec34-4da7-8d16-5970dd89890c',    price: 20.00, existence: 0, image: '', viewMenu: false },
        { id: '5c80dddf-3496-4338-86b3-f239d1e061a5', code: 'INS-0002', description: 'Masa para pizza',             isActive: true, productTypeId: '2aaec104-dc80-4a92-b748-a40a052e9ce6', categoryId: 'cb6e94d8-ec34-4da7-8d16-5970dd89890c',    price: 10.00, existence: 0, image: '', viewMenu: false },
        { id: 'c31aeb8f-b690-4866-82f1-d5093e52e145', code: 'INS-0100', description: 'Caja de carton para pizza',   isActive: true, productTypeId: '2aaec104-dc80-4a92-b748-a40a052e9ce6', categoryId: '0a50656f-62f4-4dea-a05e-66eee56aae18',    price: 0.00, existence: 0, image: '', viewMenu: false },
        { id: 'd917a3cd-1109-431a-ab73-029bdacd3279', code: 'INS-0101', description: 'Servilleta de papel',         isActive: true, productTypeId: '2aaec104-dc80-4a92-b748-a40a052e9ce6', categoryId: 'c4b0f764-3ae3-4dad-85c1-acce7e38e767',    price: 0.00, existence: 0, image: '', viewMenu: false },
        { id: '7a2d1977-47ec-4279-a5f0-7c8d74ce4f39', code: 'PLT-001',  description: 'Pizza de Peperoni',           isActive: true, productTypeId: 'e9b02730-7dab-4d68-b660-44357697c17d', categoryId: '32e7422f-1ad8-4d37-9416-36ad8bc6aec9',    price: 20.00, existence: 0, image: '', viewMenu: false },
        { id: '837d3ac7-8517-4b34-abe6-30ebb91b50c9', code: 'BBD-001',  description: 'Bebida Pepsi de 2LTS',        isActive: true, productTypeId: 'e9b02730-7dab-4d68-b660-44357697c17d', categoryId: '4be50806-7f35-45aa-b5f0-29021ef4996f',    price: 20.00, existence: 0, image: '', viewMenu: false },
        { id: 'b29c17bc-ed67-429e-ba4d-dfac5629a454', code: 'PLT-002',  description: 'Pizza Hawaiana ',             isActive: false, productTypeId: 'e9b02730-7dab-4d68-b660-44357697c17d', categoryId: '32e7422f-1ad8-4d37-9416-36ad8bc6aec9',   price: 12.00, existence: 109, image: '', viewMenu: false},
        { id: '3f1386ea-276a-4797-967f-20277286a420', code: 'PLT-003',  description: 'Papas Fransesas',             isActive: true, productTypeId: 'e9b02730-7dab-4d68-b660-44357697c17d', categoryId: '32e7422f-1ad8-4d37-9416-36ad8bc6aec9',    price: 2.00, existence: 80, image: '', viewMenu: false },
        { id: '9f88aac4-d514-4e3b-b2fb-312239cf8c75', code: 'PLT-004',  description: 'Dedos de Queso',              isActive: true, productTypeId: 'e9b02730-7dab-4d68-b660-44357697c17d', categoryId: '32e7422f-1ad8-4d37-9416-36ad8bc6aec9',    price: 10.00, existence: 80, image: '', viewMenu: false },
        { id: '20b0ea8b-40d1-4c00-80d0-d6ffd35ea6d2', code: 'PLT-005',  description: 'Alitas BQ',                   isActive: true, productTypeId: 'e9b02730-7dab-4d68-b660-44357697c17d', categoryId: '32e7422f-1ad8-4d37-9416-36ad8bc6aec9',    price: 20.00, existence: 120, image: '', viewMenu: false },
        { id: '2b6bd085-d1f3-45d5-afd5-ee5b9f57da6b', code: 'PLT-006',  description: 'Pure de Papa',                isActive: false, productTypeId: 'e9b02730-7dab-4d68-b660-44357697c17d', categoryId: '32e7422f-1ad8-4d37-9416-36ad8bc6aec9',   price: 20.00, existence: 30, image: '', viewMenu: false },
        { id: '6536a9ba-ddb4-4a17-94cc-a1790cae129a', code: 'PLT-007',  description: 'Ensalada',                    isActive: true, productTypeId: 'e9b02730-7dab-4d68-b660-44357697c17d', categoryId: '32e7422f-1ad8-4d37-9416-36ad8bc6aec9',    price: 20.00, existence: 30, image: '', viewMenu: false },
        { id: '2a4eb471-d1b7-4c06-a89d-1e7fc51c47ec', code: 'PLT-008',  description: 'Hamburgesa Pollo ',           isActive: true, productTypeId: 'e9b02730-7dab-4d68-b660-44357697c17d', categoryId: '32e7422f-1ad8-4d37-9416-36ad8bc6aec9',    price: 8.00, existence: 150, image: '', viewMenu: false },
        { id: 'e0a01cab-504f-48b5-a032-91b06b53f0d1', code: 'ING-001',  description: 'Pan de Hamburgesa',           isActive: true, productTypeId: '2aaec104-dc80-4a92-b748-a40a052e9ce6', categoryId: '3b63ffc6-1957-4550-878b-f581bfdd09db',    price: 1.00, existence: 0, image: '', viewMenu: false },
        { id: '30400ed2-8bfc-486e-b441-de5fa3fe6760', code: 'ING-002',  description: 'Jitomate',                    isActive: true, productTypeId: '2aaec104-dc80-4a92-b748-a40a052e9ce6', categoryId: '3b63ffc6-1957-4550-878b-f581bfdd09db',    price: 1.00, existence: 0, image: '', viewMenu: false },
        { id: 'ccb72b09-c3c4-4d25-865e-dae7999ef955', code: 'ING-003',  description: 'Cebolla',                     isActive: true, productTypeId: '2aaec104-dc80-4a92-b748-a40a052e9ce6', categoryId: '3b63ffc6-1957-4550-878b-f581bfdd09db',    price: 1.00, existence: 0, image: '', viewMenu: false },
        { id: '386f4d1d-09eb-41bc-a6f0-b8f7b514dfe3', code: 'ING-004',  description: 'Lechuga',                     isActive: true, productTypeId: '2aaec104-dc80-4a92-b748-a40a052e9ce6', categoryId: '3b63ffc6-1957-4550-878b-f581bfdd09db',    price: 10.00, existence: 0, image: '', viewMenu: false},
        { id: '32b25783-b599-4cac-8b03-5fa665b81994', code: 'ING-005',  description: 'Pepinillos',                  isActive: true, productTypeId: '2aaec104-dc80-4a92-b748-a40a052e9ce6', categoryId: '3b63ffc6-1957-4550-878b-f581bfdd09db',    price: 1.00, existence: 0, image: '', viewMenu: false },
        { id: 'cb9e5b5f-a864-4a4b-8a0f-9d99af85ba3e', code: 'ING-006',  description: 'Carne de Pollo (Hamburgesa)', isActive: true, productTypeId: '2aaec104-dc80-4a92-b748-a40a052e9ce6', categoryId: '3b63ffc6-1957-4550-878b-f581bfdd09db',    price: 12.00, existence: 0, image: '', viewMenu: false },
    ],

    document: [
        {id: '4a00ff37-2f05-4042-abcd-62270aaa31bb', description: 'Venta', isActive: true},
        {id: '314bc909-4e7d-423c-8c61-6fb712ab48f4', description: 'Compra', isActive: true},
        {id: '9d33b426-589a-4608-a0cc-ae94fefffe47', description: 'Devolucion de Venta', isActive: true},
        {id: '4f825fa9-16e3-4132-ab11-51421d5d5b09', description: 'Devolucion de Compra', isActive: true},
        {id: '64362875-3469-4b59-9077-3f28bd7049a6', description: 'Orden de Produccion', isActive: true},
    ],
    moviment: [
        {id: '65d35e71-af8b-4151-b079-3dc03f0e2814', date: new Date(), personId: 'bf9c6739-8612-4149-a552-5f280720cfe6', documentId: '314bc909-4e7d-423c-8c61-6fb712ab48f4', elaborateId: '', amount: 1380, status: 'terminado', referenceId: null},
    ...
    movementDetail: [
        ...
        {id: 'c11c7d82-3b1c-43a3-8429-ad60480f476d', movementId: '2e2197ab-36bb-4f07-a104-8879507b1557', quantity: 1, productId: '9f88aac4-d514-4e3b-b2fb-312239cf8c75', priceUnit: 150, subTotal: 150, tax: 24, total: 174, costUnit: 0, promotionId:  null, isActive: true},
    ...
    garrision: [
        {id: '2c873c2f-52db-4aa1-a7b2-6b5cff06a8a1', dishId: '7a2d1977-47ec-4279-a5f0-7c8d74ce4f39', garrisonId: '3f1386ea-276a-4797-967f-20277286a420', isActive: true},
        {id: '0de68899-fea9-453f-945e-9b6a8b73a87b', dishId: '7a2d1977-47ec-4279-a5f0-7c8d74ce4f39', garrisonId: '9f88aac4-d514-4e3b-b2fb-312239cf8c75', isActive: true},
        {id: 'b10abb14-94d5-4bc7-9551-4a33368a4583', dishId: 'b29c17bc-ed67-429e-ba4d-dfac5629a454', garrisonId: '3f1386ea-276a-4797-967f-20277286a420', isActive: true},
        {id: '1597485b-9551-4386-8db2-43c76eed6063', dishId: 'b29c17bc-ed67-429e-ba4d-dfac5629a454', garrisonId: '2b6bd085-d1f3-45d5-afd5-ee5b9f57da6b', isActive: true},
        {id: 'e76ac8a8-6d6d-423c-9721-c0a20d87bd69', dishId: 'b29c17bc-ed67-429e-ba4d-dfac5629a454', garrisonId: '6536a9ba-ddb4-4a17-94cc-a1790cae129a', isActive: true},
        {id: '48bfabfa-bf2e-4949-95bf-b9fd1c362e20', dishId: '2a4eb471-d1b7-4c06-a89d-1e7fc51c47ec', garrisonId: '3f1386ea-276a-4797-967f-20277286a420', isActive: true},
        {id: '4f384604-ad4b-446a-9670-d65f4d7fe174', dishId: '2a4eb471-d1b7-4c06-a89d-1e7fc51c47ec', garrisonId: '6536a9ba-ddb4-4a17-94cc-a1790cae129a', isActive: true},
        {id: '82964ef8-c556-49f7-973f-0d97b3a06433', dishId: '2a4eb471-d1b7-4c06-a89d-1e7fc51c47ec', garrisonId: '2b6bd085-d1f3-45d5-afd5-ee5b9f57da6b', isActive: true},
        {id: '53c23fd3-c721-4f6a-803a-874c96c7f77b', dishId: '2a4eb471-d1b7-4c06-a89d-1e7fc51c47ec', garrisonId: '20b0ea8b-40d1-4c00-80d0-d6ffd35ea6d2', isActive: true},
