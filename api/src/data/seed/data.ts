...
//        { id: '', profileId: '', operationId: '', createAt: new Date(), isActive: true },
    ...
    table: [
        {id: 'c1648684-78b4-43be-843f-05f00f41842f', description: 'sala 1',        status: '', isDelete: false},
        {id: 'ded0c2c7-d71e-49ed-a782-167fc07754cd', description: 'Litera 2',      status: '', isDelete: false},
        {id: 'a9e0bd06-88d7-4bd7-8488-622542a5de9e', description: 'Litera 1',      status: '', isDelete: false},
        {id: '5b72553a-cc96-41aa-bd0d-c4f82f239f2d', description: 'Frente Caja',   status: '', isDelete: false},
        {id: '500086a3-5f4f-45d4-bf67-b57c86e318ec', description: 'Patio 2',       status: '', isDelete: false},
        {id: 'c68d01a9-dc12-48b9-a954-024506425ef6', description: 'Patio 1',       status: '', isDelete: false},
        {id: '5f64b203-3399-41d2-9ce0-b90885d3b737', description: 'Sala 2',        status: '', isDelete: false},
        {id: '1543d72b-e2ea-4fc2-961b-b427cbf52c22', description: 'Patio 3',       status: '', isDelete: false},
    ],
    orderPayment: [
