...
export const seedData = {
    ...
    metric: [
        {id: 'fd4a8819-ce66-4e3c-8926-62aed1ddb3ae', operationId: '74b60331-4ade-4177-96a0-6f536c6fb5b1', name: 'Venta Total',          sentence: '', isActive: true},
        {id: '2e8aee0d-6b4c-4ddd-a23f-88f02eff5661', operationId: '7ec22367-9e62-4f25-b774-5ec2cd2cecfc', name: 'Inventario',           sentence: '', isActive: true},
        {id: '46224c20-2a8b-46e8-93b1-5d5459f008b3', operationId: 'b71aade3-6038-413d-b3dd-5bd845febba5', name: 'Ordenes del Dia',      sentence: '', isActive: true},
        {id: 'a4aa6a50-f26d-462b-8ead-b9a3ce25af48', operationId: '87fea175-12c4-47ce-aa88-545aac981f6b', name: 'Mas Vendido',          sentence: '', isActive: true},
        {id: '900d1f8e-8eae-4667-8f0d-a9c590ffcdf7', operationId: 'a0c61028-c9a8-45dd-be50-bf38edf0faf5', name: 'Compra',               sentence: '', isActive: true},
        {id: '2e4f173e-4cd4-4f6c-ae0e-05fd38134c7c', operationId: '310e91b7-d7ad-4fa4-9d02-67a6da055079', name: 'Venta',                sentence: '', isActive: true},
        {id: '8c4dda96-be9c-4699-9cd9-1e2ba13499e0', operationId: 'b4868909-5189-4711-b6cc-6b373e28a269', name: 'Ordenes del Dia',      sentence: '', isActive: true},
        {id: 'bf2445d3-3fe0-4356-a31b-5818823217d2', operationId: '2c6692b3-55a6-4c89-b001-f1760249ad4d', name: 'Ordenes Pendientes',   sentence: '', isActive: true},
        {id: 'c40745c2-6ecb-4d8b-903f-98a9c2008bce', operationId: '55440f27-9dd3-4c80-8825-96e4c921312b', name: 'Empleados Asistidos',  sentence: '', isActive: true},
        {id: '36c794b4-dcf4-437c-886c-9a4f8c9dba1c', operationId: 'c129fa82-b940-4422-acf6-696f54ffb5f4', name: 'Ordenes',              sentence: '', isActive: true},
        {id: '99b63b58-1de0-43e0-bb8a-d368a85daa1e', operationId: '5a363600-97e2-42f9-b3c2-1e9b0387e51d', name: 'Ordenes',              sentence: '', isActive: true},
        {id: '24c781af-fe27-4f31-8dc1-1ea326512ede', operationId: '4a222609-b953-4dab-b8a4-2e22b082a131', name: 'Ordenes Pendientes',   sentence: '', isActive: true},
        {id: 'ad0f8f23-3735-41a7-905b-7d5e95dba8ce', operationId: '8b54718e-b270-419c-a248-d2986e35c64c', name: 'Ventas Empleados',     sentence: '', isActive: true},
...
//        { id: '', profileId: '', operationId: '', createAt: new Date(), isActive: true },
    ...
    moviment: [
        {id: '65d35e71-af8b-4151-b079-3dc03f0e2814', date: new Date(), personId: 'bf9c6739-8612-4149-a552-5f280720cfe6', documentId: '314bc909-4e7d-423c-8c61-6fb712ab48f4', elaborateId: '', amount: 1380,     referenceId: '',  status: 'terminado'},
        {id: '145c8a51-0e93-4f02-a770-4ee9647f85cd', date: new Date(), personId: '2ffbc2df-7f6f-4c7a-bf4c-88eee010644f', documentId: '4a00ff37-2f05-4042-abcd-62270aaa31bb', elaborateId: 'b805d571-14ed-4c3e-a92b-b896ca35daeb', amount: 368,       referenceId: '',  status: 'En proceso'},
        {id: '68151027-2119-4496-ae44-c6fbbe838b85', date: new Date(), personId: '2ffbc2df-7f6f-4c7a-bf4c-88eee010644f', documentId: '4a00ff37-2f05-4042-abcd-62270aaa31bb', elaborateId: 'b805d571-14ed-4c3e-a92b-b896ca35daeb', amount: 236.4,      referenceId: '', status: 'activo'},
        {id: '2e2197ab-36bb-4f07-a104-8879507b1557', date: new Date(), personId: 'bf9c6739-8612-4149-a552-5f280720cfe6', documentId: '4f825fa9-16e3-4132-ab11-51421d5d5b09', elaborateId: '', amount: 174,    referenceId: '',  status: 'activo'},
        {id: '4e98b9ab-5d3f-4931-a3f4-719cdc7db509', date: new Date(), personId: '013d069d-744d-4eca-b041-890aaec92c3d', documentId: '9d33b426-589a-4608-a0cc-ae94fefffe47', elaborateId: '', amount: 555,    referenceId: '',  status: 'activo'},

    ],
    movementDetail: [
        {id: '0da8da8c-e91f-4951-9fc4-780aa579e7b2', movementId: '65d35e71-af8b-4151-b079-3dc03f0e2814', quantity: 20, productId: '1a3f49bd-3c1e-4fcf-b636-9c1df7d8aaae', priceUnit: 25, subTotal: 500, tax: 80, total: 580, costUnit: 0, promotionId: '', isActive: true},
        {id: 'a2ff4f48-bcee-4e47-a064-8283ad36e389', movementId: '65d35e71-af8b-4151-b079-3dc03f0e2814', quantity: 20, productId: '5c80dddf-3496-4338-86b3-f239d1e061a5', priceUnit: 25, subTotal: 500, tax: 80, total: 580, costUnit: 0, promotionId: '', isActive: true},
        {id: 'e7b57905-434f-46b6-8ed2-bd902751a2b5', movementId: '65d35e71-af8b-4151-b079-3dc03f0e2814', quantity: 20, productId: 'c31aeb8f-b690-4866-82f1-d5093e52e145', priceUnit: 126, subTotal: 200, tax: 20, total: 220, costUnit: 0, promotionId: '', isActive: true},
        {id: 'ab367239-b081-4b77-b915-283df09513f9', movementId: '145c8a51-0e93-4f02-a770-4ee9647f85cd', quantity: 1, productId: '7a2d1977-47ec-4279-a5f0-7c8d74ce4f39', priceUnit: 170, subTotal: 170, tax: 24, total: 194, costUnit: 0, promotionId: '', isActive: true},
        {id: '13ff9add-f6ab-46f1-b2a4-fe0074a5420f', movementId: '145c8a51-0e93-4f02-a770-4ee9647f85cd', quantity: 1, productId: '9f88aac4-d514-4e3b-b2fb-312239cf8c75', priceUnit: 150, subTotal: 150, tax: 24, total: 174, costUnit: 0, promotionId: '', isActive: true},
        {id: '1b8f2f4c-cdec-446a-b885-0720e3b7508a', movementId: '68151027-2119-4496-ae44-c6fbbe838b85', quantity: 1, productId: '837d3ac7-8517-4b34-abe6-30ebb91b50c9', priceUnit: 40, subTotal: 40, tax: 2.4, total: 42.4, costUnit: 0, promotionId: '', isActive: true},
        {id: 'c7b8e01a-26c9-4c6a-ae65-cd9886f375f6', movementId: '68151027-2119-4496-ae44-c6fbbe838b85', quantity: 1, productId: '7a2d1977-47ec-4279-a5f0-7c8d74ce4f39', priceUnit: 170, subTotal: 170, tax: 24, total: 194, costUnit: 0, promotionId: '', isActive: true},
        {id: 'c11c7d82-3b1c-43a3-8429-ad60480f476d', movementId: '2e2197ab-36bb-4f07-a104-8879507b1557', quantity: 1, productId: '9f88aac4-d514-4e3b-b2fb-312239cf8c75', priceUnit: 150, subTotal: 150, tax: 24, total: 174, costUnit: 0, promotionId: '', isActive: true},
        {id: '7d8d8c16-584f-4975-87af-9099e18431bb', movementId: '4e98b9ab-5d3f-4931-a3f4-719cdc7db509', quantity: 19, productId: '9f88aac4-d514-4e3b-b2fb-312239cf8c75', priceUnit: 25, subTotal: 475, tax: 80, total: 555, costUnit: 0, promotionId: '', isActive: true},
